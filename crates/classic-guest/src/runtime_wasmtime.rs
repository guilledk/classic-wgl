...
impl WasmtimeRuntime {
    ...
    fn install_imports(linker: &mut Linker<WasmtimeHost>) -> Result<(), wasmtime::Error> {
        ...
        linker.func_wrap(
            m,
            "log",
            |mut caller: Caller<'_, WasmtimeHost>, ptr: i32, len: i32| {
        ...
        linker.func_wrap(
            m,
            "spawn",
            |mut caller: Caller<'_, WasmtimeHost>, ptr: i32, len: i32| -> i32 {
        ...
        linker.func_wrap(
            m,
            "names",
            |mut caller: Caller<'_, WasmtimeHost>, out_ptr: i32, out_cap: i32| -> i32 {
        ...
        linker.func_wrap(
            m,
            "get",
            |mut caller: Caller<'_, WasmtimeHost>,
             ptr: i32,
             len: i32,
             out_ptr: i32,
             out_cap: i32|
        ...
        linker.func_wrap(
            m,
            "get_pos",
            |mut caller: Caller<'_, WasmtimeHost>, ptr: i32, len: i32, out_ptr: i32| -> i32 {
                let name = read_str(&mut caller, ptr, len);
        ...
        linker.func_wrap(
            m,
            "mouse",
            |mut caller: Caller<'_, WasmtimeHost>, out_ptr: i32| -> i32 {
        ...
        linker.func_wrap(
            m,
            "height_at",
            |mut caller: Caller<'_, WasmtimeHost>, x: f64, y: f64| -> f64 {
        ...
        linker.func_wrap(m, "agent_selected", |mut caller: Caller<'_, WasmtimeHost>| -> i32 {
        ...
        linker.func_wrap(
            m,
            "ui_consumed_click",
            |mut caller: Caller<'_, WasmtimeHost>| -> i32 {
                caller.data_mut().guest_mut().ui_consumed_click()
            },
        )?;

        linker.func_wrap(m, "delta", |mut caller: Caller<'_, WasmtimeHost>| -> f64 {
            caller.data_mut().guest_mut().delta()
        })?;

        linker.func_wrap(m, "elapsed", |mut caller: Caller<'_, WasmtimeHost>| -> f64 {
        ...
        linker.func_wrap(
            m,
            "was_pressed",
            |mut caller: Caller<'_, WasmtimeHost>, btn: i32| -> i32 {
        ...
        linker.func_wrap(
            m,
            "set_tile",
            |mut caller: Caller<'_, WasmtimeHost>, x: i32, y: i32, id: i32| -> i32 {
        ...
        linker.func_wrap(
            m,
            "set_height",
            |mut caller: Caller<'_, WasmtimeHost>, x: i32, y: i32, h: f64| -> i32 {
                caller.data_mut().guest_mut().set_height(x, y, h)
            },
        )?;

        linker.func_wrap(m, "rebuild_terrain", |mut caller: Caller<'_, WasmtimeHost>| -> i32 {
        ...
        linker.func_wrap(
            m,
            "set_camera",
            |mut caller: Caller<'_, WasmtimeHost>, x: f64, y: f64, scale: f64| -> i32 {
        ...
        linker.func_wrap(m, "mouse_wheel", |mut caller: Caller<'_, WasmtimeHost>| -> f64 {
        ...
        linker.func_wrap(
            m,
            "has_resource",
            |mut caller: Caller<'_, WasmtimeHost>, kind: i32, ptr: i32, len: i32| -> i32 {
                let name = read_str(&mut caller, ptr, len);
