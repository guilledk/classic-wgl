...
export class IsoSprite extends IsometricDrawable {
    ...
    rawDraw(): void {
        ...
        // Ghost pass: visible through occluding terrain (no bias)
        ...
        // Normal pass: on top of terrain (with bias to avoid z-fight)
        this.gl.uniform1f(this.game.shaders.imageSheet.unif.isoDepth, depth - 0.001);
